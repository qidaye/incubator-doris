...
public class SessionVariable implements Serializable, Writable {
    ...
    public static final String INVERTED_INDEX_READ_MODE_THRESHOLD = "inverted_index_read_mode_threshold";
    ...
    @VariableMgr.VarAttr(name = INVERTED_INDEX_READ_MODE_THRESHOLD,
            description = {"在通过索引查询的时候，根据查询范围的松散程度使用不同的查询方式。",
                    ...
                    + " use different query methods according to the looseness of the query scope."})
    public int invertedIndexReadModeThreshold = 0;
    ...
    public TQueryOptions toThrift() {
        ...
        tResult.setInvertedIndexReadModeThreshold(invertedIndexReadModeThreshold);
